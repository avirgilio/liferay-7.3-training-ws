...
public class TodoLocalServiceWrapper
	 ...
	 */
	@Override
	public my.todo.db.model.Todo addTodo(my.todo.db.model.Todo todo) {
	 ...
	 */
	@Override
	public my.todo.db.model.Todo createTodo(long todoId) {
	 ...
	 */
	@Override
	public my.todo.db.model.Todo deleteTodo(long todoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public my.todo.db.model.Todo deleteTodo(my.todo.db.model.Todo todo) {
	...
	@Override
	public my.todo.db.model.Todo fetchTodo(long todoId) {
	 ...
	 */
	@Override
	public my.todo.db.model.Todo fetchTodoByUuidAndGroupId(
	...
	@Override
	public java.util.Collection<my.todo.db.model.Todo> findByUserId(
		long userId) {

		return _todoLocalService.findByUserId(userId);
	}
	 ...
	 */
	@Override
	public my.todo.db.model.Todo getTodo(long todoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public my.todo.db.model.Todo getTodoByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<my.todo.db.model.Todo> getTodos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<my.todo.db.model.Todo> getTodosByUuidAndCompanyId(
	...
	public java.util.List<my.todo.db.model.Todo> getTodosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<my.todo.db.model.Todo>
			orderByComparator) {
	...
	@Override
	public my.todo.db.model.Todo updateTodo(
			long todoId, boolean completed, String description)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _todoLocalService.updateTodo(todoId, completed, description);
	}
	 ...
	 */
	@Override
	public my.todo.db.model.Todo updateTodo(my.todo.db.model.Todo todo) {
