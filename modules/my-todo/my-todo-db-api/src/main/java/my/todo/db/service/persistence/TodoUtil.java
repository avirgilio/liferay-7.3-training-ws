...
package my.todo.db.service.persistence;
...
public class TodoUtil {
	...
	public static Todo findByUuid_First(
		...
		throws my.todo.db.exception.NoSuchTodoException {
