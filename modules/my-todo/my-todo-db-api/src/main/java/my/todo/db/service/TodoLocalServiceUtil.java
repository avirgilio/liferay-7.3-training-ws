 ...
 * <code>my.todo.db.service.impl.TodoLocalServiceImpl</code> and
...
public class TodoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>my.todo.db.service.impl.TodoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static java.util.Collection<Todo> findByUserId(long userId) {
	...
	public static Todo updateTodo(
		...
		return getService().updateTodo(todoId, completed, description);
	}
