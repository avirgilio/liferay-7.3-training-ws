...
package my.todo.db.service.persistence.impl.constants;
...
public class TDPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "my.todo.db.service";
