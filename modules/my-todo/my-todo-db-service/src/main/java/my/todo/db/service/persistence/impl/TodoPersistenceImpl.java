...
package my.todo.db.service.persistence.impl;
...
import my.todo.db.exception.NoSuchTodoException;
import my.todo.db.model.Todo;
import my.todo.db.model.impl.TodoImpl;
import my.todo.db.model.impl.TodoModelImpl;
import my.todo.db.service.persistence.TodoPersistence;
import my.todo.db.service.persistence.impl.constants.TDPersistenceConstants;
...
public class TodoPersistenceImpl
	...
	@Override
	@Reference(
		target = TDPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TDPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static class TodoModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= TodoModelImpl.getColumnBitmask("userName");
