...
import my.todo.db.model.TodoModel;

/**
 * The base model implementation for the Todo service. Represents a row in the &quot;TD_Todo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TodoModelImpl extends BaseModelImpl<Todo> implements TodoModel {
	 ...
	 */
	public static final String TABLE_NAME = "TD_Todo";
	...
	public static final String TABLE_SQL_CREATE =
		"create table TD_Todo (uuid_ VARCHAR(75) null,todoId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,description VARCHAR(75) null,completed BOOLEAN)";

	public static final String TABLE_SQL_DROP = "drop table TD_Todo";

	public static final String ORDER_BY_JPQL = " ORDER BY todo.userName ASC";

	public static final String ORDER_BY_SQL = " ORDER BY TD_Todo.userName ASC";
	...
	public int compareTo(Todo todo) {
		...
		value = getUserName().compareTo(todo.getUserName());
