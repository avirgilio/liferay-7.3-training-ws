 ...
 * <code>it.formazione.liferay.elastic.dsl.service.impl.CourseLocalServiceImpl</code> and
...
public class CourseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.formazione.liferay.elastic.dsl.service.impl.CourseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Course> getCoursesByCourseType(
		int courseType, long groupId) {

		return getService().getCoursesByCourseType(courseType, groupId);
	}

	public static int getCoursesByCourseTypeCount(
		int courseType, long groupId) {

		return getService().getCoursesByCourseTypeCount(courseType, groupId);
	}

	public static List<Course> getCoursesByGroupId(long groupId) {
		return getService().getCoursesByGroupId(groupId);
	}

	public static int getCoursesByGroupIdCount(long groupId) {
		return getService().getCoursesByGroupIdCount(groupId);
	}
